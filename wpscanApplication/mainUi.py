...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.initiateManualScan.setGeometry(QtCore.QRect(300, 100, 200, 100))
        font = QtGui.QFont()
        ...
        self.automationEnable.setGeometry(QtCore.QRect(350, 250, 101, 23))
        self.automationEnable.setObjectName("automationEnable")
        self.scanProgressBar = QtWidgets.QProgressBar(self.scanTab)
        self.scanProgressBar.setGeometry(QtCore.QRect(340, 210, 120, 25))
        ...
        self.selectDay.addItem("Monday.2")
        self.selectDay.addItem("Tuesday.2")
        self.selectDay.addItem("Wednesday.2")
        self.selectDay.addItem("Thursday.2")
        self.selectDay.addItem("Friday.2")
        self.selectDay.addItem("Monday.3")
        self.selectDay.addItem("Tuesday.3")
        self.selectDay.addItem("Wednesday.3")
        self.selectDay.addItem("Thursday.3")
        self.selectDay.addItem("Friday.3")
        self.selectDay.addItem("Monday.4")
        self.selectDay.addItem("Tuesday.4")
        self.selectDay.addItem("Wednesday.4")
        self.selectDay.addItem("Thursday.4")
        self.selectDay.addItem("Friday.4")
